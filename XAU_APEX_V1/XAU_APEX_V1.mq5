//+------------------------------------------------------------------+
//|                                                XAU_APEX_V1.mq5   |
//| XAU APEX V1 - Trend Pullback / Volatility / Risk Engine          |
//|                                                                  |
//| Design goals:                                                     |
//| - Trade XAUUSD only (symbol can be broker-suffixed)              |
//| - M15 execution with H1 regime confirmation                      |
//| - EMA50/EMA200 trend + ADX + VWAP + pullback confirmation        |
//| - ATR based stop, target and position sizing                     |
//| - No grid, no martingale, no averaging down                      |
//| - Daily loss, equity DD, spread, session and loss-streak guards  |
//+------------------------------------------------------------------+
#property strict
#property version   "1.00"
#property description "XAU APEX V1 - systematic XAUUSD trend-pullback EA"
...
input string          InpComment            = "XAU APEX V1";
...
int OnInit()
{
   ...
   Print("XAU APEX V1 initialized on ", _Symbol, ". Attach to M15 for intended operation.");
...
void EvaluateEntry()
{
   ...
   // BUY: trend + HTF confirmation + VWAP + pullback into EMA50 + rejection.
...
void ManageOpenPosition()
{
   ...
   // ATR trailing after sufficient profit.
